...
class SubjectOfParticulatStudentDeanDetailActivity : AppCompatActivity() {

    var tvmkpt: TextView? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var code = intent.getStringExtra("subcode")
            ...
            for (a in 0 until eligibleSubDateToCheckFinal.size) {
                ...
                attendanceTable.child(monthofCheckDate).child(dateCheckAttendannce).child(code).child(mkpt)
                    .addValueEventListener(object : ValueEventListener {
                        override fun onCancelled(p0: DatabaseError) {
                            Toast.makeText(
                                this@SubjectOfParticulatStudentDeanDetailActivity,
