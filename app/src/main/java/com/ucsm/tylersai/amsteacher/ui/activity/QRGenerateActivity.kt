...
class QRGenerateActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val lat = sharedPreferences.getString(getString(R.string.prefLat), null)
        val lon = sharedPreferences.getString(getString(R.string.prefLon), null)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item!!.itemId) {
            ...
            R.id.menu_finish_qr_gen -> {
                ...
                val dialog = ProgressDialog(this@QRGenerateActivity)
                ...
                val studentTable =
                    FirebaseDatabase.getInstance().reference.child("ams").child("student")
                val studAry = ArrayList<Student>()
                    ...
                    override fun onDataChange(dataSnapshot: DataSnapshot) {
                        ...
                        val attendanceTable =
                            FirebaseDatabase.getInstance().reference.child("ams")
                                .child("pendingattendance")
                        val attendAry = ArrayList<Attendance>()
                        attendanceTable.child(monthFromQR).child(todayDateFromQR).child(todaySubCodeFromQR)
                            .addListenerForSingleValueEvent(object : ValueEventListener {
                                ...
                                override fun onDataChange(dataSnapshot: DataSnapshot) {
                                    ...
                                    val subjectCode = dataSnapshot.key
                                    dataSnapshot.children.forEach {
