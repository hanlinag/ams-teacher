...
import com.ucsm.tylersai.amsteacher.ui.activity.AddStudentDeanActivity
...
class AddStudentFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_add_student_dean, container, false)
        ...
        val sectionMajorClassAry = ArrayList<String?>()
        val sectionMajorClassTable =
        ...
        sectionMajorClassTable.addValueEventListener(object : ValueEventListener {
            override fun onCancelled(p0: DatabaseError) {
                Toast.makeText(
                    context,
                    "Error occured ${p0.toException().message}",
                    Toast.LENGTH_LONG
                ).show()
            }
            ...
            override fun onDataChange(dataSnapshot: DataSnapshot) {
                ...
                dataSnapshot.children.forEach {
                    ...
                    val postition = spinnerAdapter.getPosition(sectionMajorClassAry[0])
                    spinnerMajorClass.setSelection(postition)


                    //getting all the student in the specific major
                    val prestudentTable = FirebaseDatabase.getInstance().reference.child("ams")
                        ...
                        .addValueEventListener(object : ValueEventListener {
                            ...
                            override fun onDataChange(dataSnapshot: DataSnapshot) {
                                ...
                                dataSnapshot.children.forEach { it ->
                                    val prestudent = it.getValue(PreStudentList::class.java)
                                                ...
                                                prestudentTable.orderByChild("major")
                                                    ...
                                                    .addValueEventListener(object : ValueEventListener {
                                                        ...
                                                        override fun onDataChange(dataSnapshot: DataSnapshot) {
                                                            dataSnapshot.children.forEach {
                                                                val prestudent =
                                                                    it.getValue(PreStudentList::class.java)
                                                                //Log.d("Tyler", "prestudent is :::: ${prestudent!!.name}, key:: ${it.key}")
        ...
        btAddStudent.setOnClickListener {
            val intent = Intent(context, AddStudentDeanActivity::class.java)
