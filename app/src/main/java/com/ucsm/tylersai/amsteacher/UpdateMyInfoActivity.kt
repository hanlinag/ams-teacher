    ...
    override fun onOptionsItemSelected(item: MenuItem?): Boolean {
        when (item!!.itemId) {
            R.id.action_update_done -> {
                ...
                var teacher = Teacher(
                    sharedPreference.getString(getString(R.string.prefid), null),
                    sharedPreference.getString(getString(R.string.prefname), null),
                    email,
                    phone,
                    sharedPreference.getString(getString(R.string.prefpassword), null),
                    address,
                    sharedPreference.getString(getString(R.string.prefurl), null),
                    sharedPreference.getString(getString(R.string.prefisdean), null)

                )


                teacherTable.child(sharedPreference.getString(getString(R.string.prefid), null)).setValue(teacher)
    ...
    private fun uploadImageToFirebaseStorage(url: String?) {
        ...
        var profileLocationRef =
            mStorageReference?.child(
                "teacherprofileimages/id_${sharedPreference.getString(
        ...
        val urlTask = uploadTask?.continueWithTask(Continuation<UploadTask.TaskSnapshot, Task<Uri>> { task ->
            ...
            if (task.isSuccessful) {
                ...
                var teacher = Teacher(
                    sharedPreference.getString(getString(R.string.prefid), null),
                    sharedPreference.getString(getString(R.string.prefname), null),
                    sharedPreference.getString(getString(R.string.prefemail), null),
                    sharedPreference.getString(getString(R.string.prefphone), null),
                    sharedPreference.getString(getString(R.string.prefpassword), null),
                    sharedPreference.getString(getString(R.string.prefaddress), null),
                    downloadUri,
                    sharedPreference.getString(getString(R.string.prefisdean), null)
                )
                teacherTable.child(sharedPreference.getString(getString(R.string.prefid), null)).setValue(teacher)
